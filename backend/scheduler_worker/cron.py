...
from backend.scheduler_worker.dispatcher import run_dispatch_cycle
from backend.config import SCHEDULER_INTERVAL
...
def run_scheduler():
    ...
    from backend.scheduler_worker.autonomous_loop import run_opportunity_polling, run_post_verification
    ...
    # Trigger a poll immediately on startup (optional)
