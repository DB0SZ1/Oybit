...
class TimeSimulationConfig:
    """时间模拟配置（基于中国人作息习惯）"""
    # 模拟总时长（模拟小时数）
    total_simulation_hours: int = 24  # 默认模拟24小时（加速）
...
字段说明：
- total_simulation_hours (int): 模拟总时长，12-48小时，突发事件短、持续话题长
- minutes_per_round (int): 每轮时长，30-180分钟，建议60分钟
...
{{
    ...
    def _assign_initial_post_agents(
        ...
        type_aliases = {
            ...
            "techcompany": ["techcompany", "organization", "company", "person"],
        }
