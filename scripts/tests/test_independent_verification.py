...
def test_questions_bank_has_all_stages():
    ...
    from backend.onboarding.questions import get_questions_for_stage, get_total_question_count
...
def test_calibration_module_exists():
    ...
    from backend.onboarding.calibration import submit_calibration_rating
