...
def test_build_graph_from_seeds():
    ...
    from backend.intelligence.mirofish.graph_builder import build_knowledge_graph, extract_entities
...
def test_entity_extraction():
    ...
    from backend.intelligence.mirofish.graph_builder import extract_entities
